      ...
      <div className="bg-white border-b border-gray-200">
        <div className="px-8 py-6">
          <div className="flex items-center gap-4 mb-4">
            <button onClick={() => navigate(`/ib-finance/billing/${id}`)} className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg">
              <ArrowLeft className="h-5 w-5" />
            </button>
            <span className="text-sm text-gray-500">IB Finance → Billing → Edit</span>
          </div>
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-semibold text-gray-900">Edit Billing Record</h1>
              <p className="text-sm text-gray-500 mt-1">Update billing information</p>
            </div>
          </div>
        </div>
      </div>
